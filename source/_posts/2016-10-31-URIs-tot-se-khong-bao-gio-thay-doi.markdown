...
published: true
---
{% img center /images/2016/10/31/broken.jpg %}
...
# Vậy tôi phải bằt đầu từ đâu? Thiết kế URIs?
  ...
  - **Cái gì nên bỏ ra khỏi URI**
    ...
    - **Đuôi của file truy nhập** - Đây là lỗi thường gặp ".cgi" ".html" là những thứ sẽ thay đổi theo thời gian. Bạn có chắc là bạn sẽ vẫn dùng html hay cgi hay php trong 20 năm tới? Hãy Google cấu hính "[URI rewrite](https://www.google.com/search?q=uri+rewrite&oq=uri+rew&aqs=chrome.1.69i57j0l5.4990j0j7&sourceid=chrome&ie=UTF-8)" đi trời ạ.
