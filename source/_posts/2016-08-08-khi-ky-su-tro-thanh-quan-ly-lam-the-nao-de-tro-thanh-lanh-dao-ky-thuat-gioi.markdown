...
Khi bước đầu phát triển sự nghiệp, các kỹ sư chỉ tập trung củng cố và phát triển các kỹ năng kỹ thuật. Chúng ta được thăng tiến dựa trên các nhiệm vụ hữu hình và đo đếm được, ví dụ như học một ngôn ngữ mới hay làm chủ một công nghệ mới. Tuy nhiên một khi chúng ta chuyển sang làm quản lý, mọi thứ thay đổi hoàn toàn. Khi làm quản lý, thành công của chúng ta dựa trên phần lớn các đặc điểm vô hình, trừu tượng như kỹ năng làm việc nhóm, khả năng lãnh đạo và giao tiếp. Những kỹ năng này có đặc tính chủ quan, có nghĩa là tự tiến bộ của chúng ta khó cân đong đo đếm, mà phụ thuộc vào nhận thức của người khác về những cố gắng của mình. Đây là quả đắng mà hầu hết các quản lý kỹ thuật mới phải chấp chận.
