...
description: Khi kỹ sư trở thành quản lý, Làm thế nào để trở thành lãnh đạo kỹ thuật giỏi
...
Có một thách thức lớn là một kỹ sư giỏi không phải tự nhiên trở thành một lãnh đạo giỏi. Khả năng lãnh đạo bất kỳ ai ở cương vị nào không phải tự nhiên mà có. Lãnh đạo là kỹ năng phải được rèn luyện cả cuộc đời.

<!-- more -->

Để giúp các quản lý kỹ thuật mới chuyển đổi từ người cộng sự thành người lãnh đạo, tôi thường làm việc với họ để phát triển một loạt các kỹ năng không liên quan gì đến kỹ thuật. Mặc dù không ai giống ai, tôi nhận thấy rằng các nguyên lý được vạch ra sau đây là nền tảng tốt cho những ai muốn trở thành một lãnh đạo công nghệ *hiệu quả* - một người có thể dẫn dắt đồng đội, triển khai thay đổi và liên tục gặt hái được kết quả tốt.

1. Phát triển tư duy hướng kinh doanh và biết cảm thông
-------------------------------------------------------

Khi còn là cộng sự, bạn xem xét công nghệ với con mắt thuần tuý của kỹ sư thì chấp nhận được. Bạn có nhiều thời gian để tập trung vào việc "làm thế nào" và không cần phải tập trung cho câu hỏi "tại sao". Điều này có nghĩa là khi còn là cộng sự, bạn thoải mái lựa chọn công nghệ mà không phải tính đến sự ảnh hưởng của nó tới kinh doanh mà để cho cấp lãnh đạo tính các phương án khả thi thực tế trong thế giới thực. Tuy nhiên, khi bạn trở thành lãnh đạo, bạn không còn được xa xỉ thế này nữa. Vì bạn giờ đã là quản lý, bạn phải đưa ra quyết định dựa trên những thực tế rối rắm của kinh doanh như các ràng buộc tài chính, văn hoá của tổ chức, chính trị nơi công sở, nhược điểm của con người và các kết quả kinh doanh.

Các nhà quản lý mới thường mắc lỗi khi đưa ra các khởi xướng dựa trên các thuật ngữ kỹ thuật thay vì các thuật ngữ kinh doanh và vì thế họ trở lên bất lực khi không nhận được các hỗ trợ đúng đắn, kịp thời. Họ kỳ vọng doanh nghiệp hiểu rõ quan điểm kỹ thuật nhưng cuối cùng nhận ra rằng việc của họ là phải đặt các khuyến nghị của mình trên quan điểm kinh doanh.

Cách tốt nhất để vượt qua lỗi này là dành thời gian tìm hiểu các chỉ số kinh doanh mà công ty quan tâm nhất và hiểu được những khó khăn gây ra cho những phòng ban khác. Để làm được điều này cần sự cảm thông - một kỹ năng không thể thiếu của một lãnh đạo hiệu quả. Các quản lý công nghệ nên trao đổi với các đồng nghiệp và lắng nghe các khó khăn, thách thức từ họ. Các quản lý cũng nên hiểu rõ các chỉ số chính của kinh doanh và biết được những yếu tố nào thúc đẩy các chỉ số này. Họ phải từ bỏ kỹ năng phân tích và lượng hoá kiểu kỹ thuật mà phải áp dụng các kỹ năng này cho các vấn đề thiên về quản lý. Một khi họ làm được điều này, họ sẽ trở thành lãnh đạo kinh doanh thay vì đơn thuần là nhà công nghệ, và họ có thể bắt đầu những cuộc trao đổi sâu sắc để xây dựng, phát triển doanh nghiệp.

2. Phát triển tư duy hướng giải pháp
------------------------------------

Một khía cạnh khác của khả năng lãnh đạo mà các quản lý mới thường gặp khó khăn là làm sao để hiểu cách tiếp cận các vấn đề nằm ngoài sự kiểm soát trực tiếp của mình. Các thay đổi trong tầm ảnh hưởng trực tiếp của quản lý có thể triển khai được ngay. Ví dụ, nếu một quản lý đảm bảo chất lượng (QA) muốn sử dụng thêm Cucumber vào chạy kiểm thử tự động để khuyến khích phương pháp phát triển hướng hành vi (BDD), thì người đó không cần phải lên lịch họp hành với các phòng ban khác để thực hiện việc này. Nhưng nếu một quản lý kỹ thuật muốn thay đổi cách quản lý dự án từ phương pháp Waterfall sang phương pháp Agile thì người đó sẽ cần rất nhiều thời gian làm việc với nhiều người nằm ngoài phòng ban của mình vì đây là thay đổi tổ chức rất lớn.

Khi phải đối mặt với những vấn đề nằm ngoài tầm kiểm soát trực tiếp, những nhà quản lý mới thường đầu hàng quá sớm và leo thang kết luận quá vội vàng: "Tôi đã gửi email tới Tom trong nhóm Quản Lý Chương trình về việc áp dụng Scrum cho sự án tiếp theo, nhưng anh ta chẳng trả lời tôi. Rõ ràng là tổ chức ta chưa sẵn sàng để áp dụng phương pháp Agile." Trong những tương huống như vậy, khi các quản lý mới kết luận leo thang chưa chín chắn, thì chính họ đang trao vấn đề đó tới cấp quản lý cao hơn thay vì tự mình xử lý vấn đề. Điều này là chấp nhận được khi bạn còn là cộng sự, nhưng không chấp nhận được khi bạn đã là lãnh đạo.

Khi là lãnh đạo, bạn cần có khả năng vượt qua các chướng ngại nằm ngoài tầm kiểm soát trực tiếp của mình. Điều này có nghĩa là bạn cần thuyết phục quản lý khác ở phòng ban khác đồng ý áp dụng quy trình mới theo đề xuất của bạn. Hoặc nếu bạn là cấp điều hành, điều này có nghĩa là bạn cần giải quyết các vấn đề nằm xa ngoài tầm kiểm soát của mình, ví dụ như đưa ra bản kế hoạch để tăng doanh thu trong thời kì suy thoái kinh tế. Chìa khoá để dẫn tới thành công là phát triển tư duy hướng giải pháp.

Tư duy hướng giải pháp là cách nhìn tập trung vào mục tiêu hơn là vấn đề. Khi bạn phát triển tư duy hướng giải pháp, bạn tập trung công sức của mình để giành được kết quả mong muốn và bạn không phung phí thời gian để phàn nàn về những rào cản bạn gặp phải - bạn chỉ cần tìm cách vượt qua chúng. Quản lý của bạn khi đó sẽ trở thành bạn đường để giúp bạn giành được mục tiêu chứ không phải là người giải quyết các vấn đề hộ bạn. Một lãnh tạo có tư duy hướng giải pháp đưa ra các giải pháp tiềm năng khi cần tham vấn lãnh đạo của mình, và người đó tận dụng kỹ năng chuyên môn cũng như tầm ảnh hưởng của mình trong tổ chức để theo đuổi và hoành thành mục đích của mình.

3. Xây dựng kết nối và lấy được niềm tin từ mọi người
-----------------------------------------------------

Các công ty cần thiết phải phân chia nhân viên của mình vào các phòng ban theo cấu trúc phân cấp để dễ bề quản lý. Tuy nhiên thực tế cho thấy nhiều công ty phân chia khá lỏng lẻo. Chúng tồn tại đơn giản chỉ để quản lý kinh doanh. Có một thách thức là hầu hết các vấn đề kinh doanh cần sự quan tâm lớn lại hầu như không giải quyết tốt được trong các gianh giới được tổ chức lỏng lẻo mà chúng ta đã định ra - mà các vấn đề này nằm rải rác toàn bộ các phòng ban. Do đó, các lãnh đạo công nghệ hiệu quả cần thật tinh thông khi làm việc với nhiều phòng ban để triển khai thay đổi, và để làm được điều này cần sự kết nối chặt chẽ.
...
Có một cách hiệu quả để tạo lập các mối quan hệ là không chỉ tập trung cho công việc của mình mà hãy đi giúp đỡ những người khác trong tổ chức của mình. Tình nguyện giúp ai đó với những khởi xướng của họ, hay giúp đỡ thật nhiệt thành khi ai đó nhờ vả. Điều này giúp bạn có cơ hội tương tác với những người nằm ngoài phòng ban của mình và nó sẽ giúp xây dựng niềm tin.

Cũng đừng quên tham dự các sự kiện giao lưu của công ty và xem đây là cơ hội để gặp gỡ những người ngoài phòng ban của mình. Bạn không cần phải là người đi giao lưu với trình độ bán hàng dẻo miệng ở những sự kiện này mà chỉ cần thử thách bản thân gặp một người mới mỗi lần là được. (Và cũng đừng sợ sệt khi giới thiệu mình với những người cấp cao hơn - họ cũng chỉ là những con người bình thường như bạn thôi). Thậm chí nếu bạn không biết nói gì khi giao lưu công ty thì hãy thân thiện với một đồng nghiệp ở sự kiện đó, điều này sẽ giúp bạn tiếp cận họ dễ hơn trong tương lai.

Khi bạn bắt đầu xây dựng kết nối trong công ty, bạn sẽ thấy mạng lưới kết nối này cho bạn nhiều sức mạnh hơn. Khi bạn biết cần gọi cho ai để xử lý được công việc và họ biết và tôn trọng bạn, khi đó bạn có thể "dời núi lấp biển" được. Các khởi xướng qua nhiều phòng ban trở thành cơ hội tốt để được kết nối với các đồng nghiệp để xử lý các vấn đề lớn. Các thay đổi diễn ra thuận lợi hơn bởi vì bạn đã thiết lập được niềm tin và có thể nhanh chóng xử lý vấn đề luôn. Và khi đó nhu cầu leo thang tham vấn tới lãnh đạo của bạn sẽ giảm bởi vì bạn không cần phải nhờ họ giúp mỗi khi bạn cần làm việc với những người thuộc phòng ban khác.


4. Hiểu rằng mỗi người có những nhận thức khác nhau về mình
-----------------------------------------------------------

Khi bước đầu phát triển sự nghiệp, các kỹ sư tập trung củng cố và phát triển các kỹ năng kỹ thuật. Chúng ta được thăng tiến dựa trên các nhiệm vụ hữu hình và đo đếm được, ví dụ như học một ngôn ngữ mới hay làm chủ một công nghệ mới. Tuy nhiên một khi chúng ta chuyển sang làm quản lý, mọi thứ thay đổi hoàn toàn. Khi làm quản lý, thành công của chúng ta dựa trên phần lớn các đặc điểm vô hình, trừu tượng như kỹ năng làm việc nhóm, khả năng lãnh đạo và giao tiếp. Những kỹ năng này có đặc tính chủ quan, điều đó có nghĩa chúng ta mất đi thước đo về tự tiến triển của nó mà phụ thuộc vào nhận thức của người khác về những cố gắng của mình. Đây là viên thuốc rất đắng mà hầu hết các quản lý kỹ thuật mới phải uống.

Điều này có vẻ không công bằng, nhưng đây là cách thế giới vận hành. Khi nói đến khả năng lãnh đạo, sự hiệu quả của bạn dựa trên phần lớn nhận thức của các quản lý, thành viên nhóm và đồng nghiệp của bạn cho dù mục đích của bạn thế nào đi nữa khi bạn soạn thảo một email, bài thuyết trình hay bình luận trong cuộc họp. Mọi người xung quanh đánh giá bạn thông qua từng hành động nhỏ nhất của bạn khi giao tiếp và họ có những kết luận riêng về những gì bạn nói. Họ cũng tiếp nhận thông tin về bạn từ tay thứ ba, có nghĩa là dựa trên những đánh giá của người khác về những hành động của bạn.

Các lãnh đạo thành công hiểu rằng mỗi người có những nhận thức khác nhau về mình, và họ không phung phí thời gian để phàn nàn về điều này. Thay vào đó, họ chủ động và làm thật rõ vấn đề khi giao tiếp và họ cố gắng gấp đôi khi mọi người nhận thức không đúng về các hành động của họ. Đây là lý do vì sao tôi làm việc với các kỹ năng giao tiếp với mọi quản lý khi báo cáo cho tôi. Chúng tôi thường phân tích email và trao đổi thực tiếp thêm ở cấp thấp nhất bởi vì từng hành động nhỏ trong giao tiếp đều hết sức quan trọng. Các điều đơn giản như ngôn ngữ cơ thể, cách ăn mặc, và giọng điệu là những yếu tố cực kỳ quan trọng để mọi người nhận thức về bạn. Và đây là điều rất khó để mọi người đánh giá bản thân mình trong các lĩnh vực như vậy.


5. Tiếp nhận tư duy hướng vận hành
----------------------------------

Khả năng triển khai thay đổi để hoạt động lâu dài là một thành phần chủ chốt của lãnh đạo hiệu quả. Thật không may, hầu hết các quản lý mới tập trung quá nhiều vào việc triển khai các khởi xướng ban đầu của mình mà không xem xét làm thế nào để hỗ trợ chương trình đó lâu dài. Xây dựng tư duy hướng vận hành giúp bạn vượt qua lỗi này. Tư duy hướng vận hành là quan điểm xem xét các nhiệm vụ tiếp theo cần thực hiện để hỗ trợ toàn bộ vòng đời của một chương trình.

Theo lẽ tự nhiên, các quản lý mới thường hào hứng trong giai đoạn đầu khi triển khai khưởng xướng mới. Đây là khoảng thời gian tràn đầy nhiệt thành khi họ tập trung đưa khởi xướng của mình vào áp dụng thực tế bằng cách viết tài liệu mô tả ý tưởng, tăng sự hỗ trợ và triển khai các công cụ công nghệ liên quan. Đây là việc đáng tưởng thưởng vì nó cần sự cố gắng cực kỳ lớn, nhưng đây chỉ là khởi đầu. Giai đoạn tiếp theo được biết đến là giai đoạn "thung lũng của sự tuyệt vọng" khi mọi thứ vượt quá tầm kiểm soát. Luồng công việc có vẻ hoàn hảo trên bàn giấy lại không hoạt động tốt ngoài thực tế. Các thủ tục mới bị bỏ qua và mọi người bắt đầu nói xấu về các công cụ công nghệ mới. Và điều tồi tệ nhất là khi mọi người bắt đầu không còn tin tưởng vào bản thân khởi xướng này nữa.
...
- "The Five Dysfunction of a Team" bởi Patrick Lencioni. Một cuốn kinh điển về sự cơ năng của nhóm. Một cuốn ngắn gọn và vui.
